              ...
              <li>
                <div class="about-slider">
                  <div class="col-lg-3 col-md-3 col-sm-4 col-xs-12">
                    <img src="{{ asset('motor/img') }}" class="img-responsive" alt="Image">
                  </div>
                  <div class="col-lg-9 col-md-9 col-sm-8 col-xs-12 about-slider-description">
                    ...
                    <p class="welcome-message">Nama Lengkap : Edo Galih Rispianto <br> Tempat tanggal lahir : Kediri, 12 Januari 2002<br>
                    Jenis Kelamin : Laki Laki<br> Hobby : Trabas <br> Makanan favorit : Bakso<br>
